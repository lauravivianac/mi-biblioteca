...
import * as shelvesui from './shelvesui.js';
import * as habitoui from './habitoui.js';
import * as avisosui from './avisosui.js';
...
Object.assign(window, {
  ...
  ...exploreui, ...chatui, ...postsui, ...lugaresui, ...shelvesui, ...habitoui, ...avisosui,
  ...petchat, ...petask,
